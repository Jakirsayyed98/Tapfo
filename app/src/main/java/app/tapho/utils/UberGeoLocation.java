...
public class UberGeoLocation extends WebChromeClient {

    private UberFragment activity2;

    public UberGeoLocation(UberFragment uberFragment) {
        this.activity2 = uberFragment;
    }

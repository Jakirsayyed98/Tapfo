...
public class GeoWebChromeClientWebViewActivityForOffer extends WebChromeClient {
    private  WebViewActivityForOffer activity;


    public GeoWebChromeClientWebViewActivityForOffer(WebViewActivityForOffer activity) {

...
import app.tapho.ui.Cabs.OlaCabsFragment;
import app.tapho.ui.WebViewActivity;

public class GeoWebChromeClientForOla extends WebChromeClient {
    private OlaCabsFragment Fragment;


    public GeoWebChromeClientForOla(OlaCabsFragment activity) {

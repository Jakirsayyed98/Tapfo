...
import app.tapho.ui.model.NewHomeRes.BannerList1
...
class GamezopTrendingGameAdapter<S>(private val clickListener: RecyclerClickListener) :
    ...
    inner class Holder(private val binding: PopulargamesBinding) :
...
//                val myRandomValues =  List(10) { Random.nextInt(0, listSize) }
                ...
                Glide.with(itemView.context).load(s.assets.wall).centerCrop().into(binding.ivPartner)

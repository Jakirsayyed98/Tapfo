...
import app.tapho.databinding.FragmentWalletOnBoardingBinding
...
class WalletOnBoardingFragment : BaseFragment<FragmentWalletOnBoardingBinding>() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentWalletOnBoardingBinding.inflate(inflater,container,false)
        statusBarTextBlack()
        statusBarColor(R.color.GreenWalletBackgroundDark)
        val bannerdata: MutableList<sliderItem> = ArrayList()
        bannerdata.add(sliderItem(R.drawable.wallets1))
        bannerdata.add(sliderItem(R.drawable.wallets2))
        bannerdata.add(sliderItem(R.drawable.wallets3))
        bannerdata.add(sliderItem(R.drawable.wallets4))
        Setbannerdata(bannerdata)
        _binding!!.btnContinue.setOnClickListener {
            getSharedPreference().saveString("WalletOnBordingStatus","1")
    ...
    companion object {
        @JvmStatic
        fun newInstance() =
            WalletOnBoardingFragment().apply {

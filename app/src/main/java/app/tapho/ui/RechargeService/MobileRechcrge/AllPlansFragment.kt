...
class AllPlansFragment : BaseFragment<FragmentAllPlansBinding>() ,ApiListener<getRechargePlans,Any?>,RecyclerClickListener{
  ...
  var opretorName=""
    ...
    override fun onCreateView(
        ...
        AllplansBinding!!.opretorName.text = opretorName
        AllplansBinding!!.number.text =  mobileNumber +" - "+circle_name
    ...
    private fun filterListData(searchName: String) {
        var tempList: ArrayList<PlanDescription> = ArrayList()
        for (x in itemList){

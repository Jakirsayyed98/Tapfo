...
class AllRestorantsAdapter(private val clickListener: RecyclerClickListener) :
    BaseRecyclerAdapter<FoodCustomeSuperCategoryModel, AllRestorantsAdapter.Holder>() {

    inner class Holder(val binding: AllRestorantsLayoutBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        return Holder(
            AllRestorantsLayoutBinding.inflate(

...
import app.tapho.databinding.RasturantsofferandcouponsLayoutBinding
...
class RestorantsOfferAndCouponsAdapter(private val clickListener: RecyclerClickListener) :
    BaseRecyclerAdapter<FoodCustomeSuperCategoryModel, RestorantsOfferAndCouponsAdapter.Holder>() {

    inner class Holder(val binding: RasturantsofferandcouponsLayoutBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        return Holder(
            RasturantsofferandcouponsLayoutBinding.inflate(

...
import app.tapho.ui.home.SearchAndComare.location.GeoWebChromeClientShopCluse
import app.tapho.utils.REQUEST_FINE_LOCATION
import java.net.URISyntaxException


class ShopCluseFragment : BaseFragment<FragmentAmazonBinding>() {
...
//        binding.webView.settings.builtInZoomControls = true
        ...
        _binding!!.webView.webChromeClient = GeoWebChromeClientShopCluse(this)
...
//                    toast("Internet error")
        ...
        var Url= "https://bazaar.shopclues.com/search?q="+ SearchAndCompareFragment.dataQuery

...
class StrategyGameCategoryAdapter<S>(private val clickListener: RecyclerClickListener) :
    BaseRecyclerAdapter<S, StrategyGameCategoryAdapter<S>.Holder>()  {
    var totalplays=""
...
//    inner class Holder(private val binding: RowGamesBinding) :
    inner class Holder(private val binding: MostplayedGameLayoutBinding) :

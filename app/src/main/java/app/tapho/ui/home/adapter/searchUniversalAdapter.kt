...
import app.tapho.databinding.SearchItemLayoutBinding
...
class searchUniversalAdapter <S>(private val clickListener: RecyclerClickListener) :
    BaseRecyclerAdapter<S, searchUniversalAdapter<S>.Holder>() {
    ...
    inner class Holder(private val binding: SearchItemLayoutBinding) :

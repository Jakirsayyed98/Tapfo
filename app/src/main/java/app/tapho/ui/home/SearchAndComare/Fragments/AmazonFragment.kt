...
import app.tapho.utils.ICON_URL
import app.tapho.utils.REQUEST_FINE_LOCATION
import app.tapho.utils.WEB_VIEW_URL
import java.net.URISyntaxException


class AmazonFragment : BaseFragment<FragmentAmazonBinding>() {
...
//        binding.webView.settings.builtInZoomControls = true
        ...
        _binding!!.webView.webChromeClient = GeoWebChromeClientAmazon(this)
...
//                    toast("Internet error")
            ...
            override fun shouldOverrideUrlLoading(view: WebView, url123: String?): Boolean {
                ...
                var Url= "https://www.amazon.in/s?k="+SearchAndCompareFragment.dataQuery

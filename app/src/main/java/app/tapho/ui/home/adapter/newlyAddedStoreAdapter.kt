...
class newlyAddedStoreAdapter <S>(private val clickListener: RecyclerClickListener) :
    BaseRecyclerAdapter<S, newlyAddedStoreAdapter<S>.Holder>() {
    ...
    inner class Holder(private val binding: NewlyaddedStoreBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        return Holder(
            NewlyaddedStoreBinding.inflate(

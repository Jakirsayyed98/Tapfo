...
import app.tapho.databinding.FragmentTatacliqBinding
...
import app.tapho.ui.home.SearchAndComare.location.GeoWebChromeClientTataCliq
import app.tapho.utils.REQUEST_FINE_LOCATION
import java.net.URISyntaxException


class TatacliqFragment : BaseFragment<FragmentTatacliqBinding>() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTatacliqBinding.inflate(inflater,container,false)
        initWebView()
...
//        binding.webView.settings.builtInZoomControls = true
        ...
        _binding!!.webView.webChromeClient = GeoWebChromeClientTataCliq(this)
...
//                    toast("Internet error")
        ...
        var Url= "https://www.tatacliq.com/search/?searchCategory=all&text="+ SearchAndCompareFragment.dataQuery

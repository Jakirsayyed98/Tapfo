...
import app.tapho.R
import app.tapho.databinding.FragmentFlipkartBinding
...
import app.tapho.ui.home.SearchAndComare.location.GeoWebChromeClientFlipkart
import app.tapho.utils.REQUEST_FINE_LOCATION
import java.net.URISyntaxException


class FlipkartFragment : BaseFragment<FragmentFlipkartBinding>() {
    ...
    override fun onCreateView(
       ...
       _binding = FragmentFlipkartBinding.inflate(inflater,container,false)
        initWebView()
...
//        binding.webView.settings.builtInZoomControls = true
        ...
        _binding!!.webView.webChromeClient = GeoWebChromeClientFlipkart(this)
...
//        var Url= "https://www.flipkart.com/search?q="+SearchAndCompareFragment.dataQuery
        var Url= "https://www.flipkart.com/search?q="+SearchAndCompareFragment.dataQuery

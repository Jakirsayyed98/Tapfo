...
import app.tapho.ui.home.SearchAndComare.Fragments.ShopCluseFragment;

public class GeoWebChromeClientShopCluse extends WebChromeClient {

    private ShopCluseFragment activity2;

    public GeoWebChromeClientShopCluse(ShopCluseFragment FlipkartFragment) {

...
import app.tapho.ui.home.SearchAndComare.Fragments.TatacliqFragment;

public class GeoWebChromeClientTataCliq extends WebChromeClient {

    private TatacliqFragment activity2;

    public GeoWebChromeClientTataCliq(TatacliqFragment FlipkartFragment) {

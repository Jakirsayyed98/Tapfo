...
//            Handler().postDelayed({
//                binding!!.backbtnWeb.visibility = View.VISIBLE
//            }, 10000)
        ...
        Glide.with(this).asBitmap().load(arguments?.getString(DATA)).into(object : BitmapImageViewTarget(view.findViewById(R.id.imageIv)) {
      ...
      //      cashbackTv.text = URLDecoder.decode(cashback, "UTF-8")

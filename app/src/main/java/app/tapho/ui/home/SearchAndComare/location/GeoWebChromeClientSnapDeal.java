...
import app.tapho.ui.home.SearchAndComare.Fragments.SnapDealFragment;

public class GeoWebChromeClientSnapDeal extends WebChromeClient {

    private SnapDealFragment activity2;

    public GeoWebChromeClientSnapDeal(SnapDealFragment FlipkartFragment) {

...
//            binding.homeTab -> addFragment(HomeFragment.newInstance())
            ...
            binding.tCashTab -> addFragment(TCashDashboardFragment.newInstance(""))
            binding.ShopNow -> addFragment(ShopFragment.newInstance())
            binding.offerTab -> addFragment(OffersFragment.newInstance())
            binding.Cashback -> addFragment(OnlyCashbackStoresFragment.newInstance())
            binding.Games -> addFragment(GameFragment.newInstance())

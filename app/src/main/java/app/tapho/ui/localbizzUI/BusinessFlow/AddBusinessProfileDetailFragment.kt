...
//            getImageView().setImageBitmap(r.getBitmap());
        ...
        _binding!!.apply {
            ...
            businessPhoneNumber.setOnClickListener{
                LocalbizContainerActivity.openContainer(requireContext(),"AddBusinessPhone_Number")
            }
            businessDiscription.setOnClickListener {
                if (getSharedPreference().getString("profile_image").isNullOrEmpty()){
                    Snackbar.make(requireView(),"You have to upload both image", Toast.LENGTH_SHORT).show()
                }else{
                    LocalbizContainerActivity.openContainer(requireContext(), "businessDiscription")
                }
            ...
            businessEmail.setOnClickListener {
                if (getSharedPreference().getString("secondary_number").isNullOrEmpty()){
                    ...
                    LocalbizContainerActivity.openContainer(requireContext(), "businessEmail")
                }
            ...
            businessWhatsappNumber.setOnClickListener {
                if (getSharedPreference().getString("secondary_number").isNullOrEmpty()){
                    ...
                    LocalbizContainerActivity.openContainer(requireContext(), "businessWhatsappNumber")
                }
...
//
//        getSharedPreference().saveString("profile_image",reducedImage.toString())
//        Log.d("ImageProfile",image.toString())
//        Log.d("ImageProfile",reducedImage.toString())
//        Glide.with(requireContext()).load(reducedImage.toString()).circleCrop().centerCrop().into(_binding!!.iconProfile)

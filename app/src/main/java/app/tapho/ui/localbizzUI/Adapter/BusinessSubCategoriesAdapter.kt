...
import app.tapho.R
import app.tapho.databinding.BusinessSubCategoriesBinding
...
class BusinessSubCategoriesAdapter <S>(private val clickListener: RecyclerClickListener) :
    BaseRecyclerAdapter<S, BusinessSubCategoriesAdapter<S>.Holder>() {
    ...
    inner class Holder(private val binding: BusinessSubCategoriesBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        return Holder(BusinessSubCategoriesBinding.inflate(LayoutInflater.from(parent.context),
            parent,
            false))
    }

...
class Fragment_favorite_nav : BaseFragment<FragmentFavoriteNavBinding>(), ApiListener<HomeRes, Any?>,
    ...
    override fun onCreateView(
        ...
        statusBarColor(R.color.favstatus)

        favBinding!!.backbutton.setOnClickListener {
            activity?.onBackPressed()
        }
        favBinding!!.exploreMore.setOnClickListener {
        ...
        favBinding!!.searchTool.setOnClickListener {
